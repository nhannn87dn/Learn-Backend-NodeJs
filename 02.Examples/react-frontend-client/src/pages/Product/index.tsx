...
const Product = () => {
  ...
  return (
    <>
      ...
      {productQuery.data && productQuery.data.map((product: Product) => (
      ...
      {
        productQuery.data && productQuery.data.length > 0 ? (<><Pagination
      ...
      /></>)  : null
                  ...
                  <p className='my-3'>Tham khảo phân trang: https://hygraph.com/blog/react-pagination hoặc https://www.educative.io/answers/how-to-implement-pagination-in-reactjs</p>
